...
\small Web: \url{http://bit.ly/vvasuki}\\} & 
...
\section{Summary} 
\begin{itemize}
 \item \textbf{As a researcher}: Interest and academic experience in analysis and applications of statistical inference algorithms, Theoretical computer science.
 \item \textbf{As a data analyst}: Worked on problems of commercial and scientific interest.
 \item \textbf{As software engineer}: Proven skills in development, team-work and oral /written communication.
\end{itemize}
\end{comment}
...
\section{Code samples/ Open Source projects}
\begin{itemize}
\headeditem{} \href{http://sanskritnlp.appspot.com/}{Started} various \href{https://github.com/sanskrit-coders/}{Sanskrit Natural Language Processing projects}. \textit{Language}: Scala, Java, Python.
\headedsubitem{Highlights} Published several sanskrit dictionaries, created a mobile app to conveniently install them.
\headeditem{} \href{https://bitbucket.org/vvasuki/bootpos}{Part of speech} tagging bootstrapped with wiktionary. \textit{Language}: Scala
\headeditem{}Minor contributions to  \href{https://sourceforge.net/projects/parallelcolt/}{ParallelColt} (An efficient scientific computing library in Java). 
\headeditem{}Software for early research: See  \href{sites.google.com/site/vishvasvasuki/}{website}. \textit{Language}: Matlab, R.
\end{itemize}
...
\begin{itemize}
\headeditem{Avocation:} Sanskrit, Poetry, shAstra, Nature, Hiking, Socio-cultural discourse.
...
\item \href{http://www.cs.cmu.edu/~antoine/}{Antoine Raux}, Scientist, Honda Research Institute.
